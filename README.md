...
You can clear the entire canvas and save it as a static image.
There are four brush stroke widths.
The color palette is based on our personal preference of colors and no colors will be added.
You can undo and redo using the z and x buttons, respectively.
